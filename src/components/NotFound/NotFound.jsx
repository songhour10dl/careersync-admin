...
const NotFound = ({ platform: propPlatform = null, dashboardPath = null }) => {
  ...
  const getDashboardPath = () => {
    ...
    if (platform === PLATFORMS.STUDENT) {
      return '/student/dashboard' // Student dashboard route (can be configured)
    }
    return '/' // Mentor dashboard route (home page)
  }
  ...
  return (
    <Container
      ...
      sx={{
        ...
        padding: 0,
        margin: 0,
        marginBottom: '-40px', // Counteract parent's paddingBottom to eliminate gap with footer
